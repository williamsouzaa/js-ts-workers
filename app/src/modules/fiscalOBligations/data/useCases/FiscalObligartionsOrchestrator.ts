...
import { IFiscalObligationsEventsPackage, TPackageReference } from "../../domain/contracts/IFiscalObligationsEventsPackage.js"
import { TFiscalOBligationsEntryData } from "../../domain/contracts/TFiscalOBligartionsEntryData.js"
import { E_WORKER_PROCESS, E_OBRIGACAO, E_OBRIGACAO_CODIGO_LAYOUT, E_LAYOUTS_PACKAGE_SIZE } from "../../domain/names.js"
...
export class FiscalOBligationsOrchestrator {
  constructor(
    ...
    private workerThreadManager: IWorkerThreadPool<TFiscalOBligationsEntryData>,
  ...
  private async awaitWorkerThreadIsIdle(workerThread: IWorkerThread<TFiscalOBligationsEntryData>): Promise<void> {
    while(true) {
