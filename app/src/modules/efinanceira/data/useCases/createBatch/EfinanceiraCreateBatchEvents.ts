...
export class EfinanceiraCreateBatchEvents implements ICreateBatchEvents<Array<{idGov: string, xmlSigned: string}>> {
  ...
  constructor() {
    this.certGov = handleReadFileSync(CERT.EFINANCEIRA.GOV.CERT_BASE_PATH, CERT.EFINANCEIRA.GOV.CERT_FILE_NAME) as string
  }
...
<eFinanceira xmlns="http://www.eFinanceira.gov.br/schemas/envioLoteCriptografado/v1_2_0">
  <loteCriptografado>
    ...
    <idCertificado>${CERT.EFINANCEIRA.GOV.CERT_THUMBPRINT}</idCertificado>
